// Protocolo de Mensajes (un datagrama por mensaje):
//   - "SUB <tema>" -> registra al remitente como suscriptor de <tema>
//   - "PUB <tema> <mensaje>" -> reenvía <mensaje> a los suscriptores de <tema>
//
